...
var metas = {
	// 下面几种是显示描述的
	component: require('./metas/component'), // ui.define/ui.define1/ui.parent
	option: require('./metas/option'), // ui.option
	request: require('./metas/request'), // ui.request
	// 下面几种是命名描述的
	eventmethod: require('./metas/eventmethod'), // _method
	onmethod: require('./metas/onmethod'), // onMethod
	submethod: require('./metas/submethod'), // sub_method
	subsubmethod: require('./metas/subsubmethod') // sub_sub_method
};

// 命名描述的模式meta，通过一下decorator进行检测和处理，返回meta实例
...
this.ComponentClass = new Class(Type, function() {
	...
	/**
	 * Component创建完毕后，还可以通过SomeComponent.set为其添加成员
	 */
...
this.Component = new exports.ComponentClass(function() {
	...
	/**
	 * 统一的aop注册入口
	 * 统一入口可统一记录所有aop注册，在destroy时统一清除
	 */
