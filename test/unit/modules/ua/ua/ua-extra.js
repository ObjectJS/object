...
var userAgents_extra = [
//Maxthon
{
	str : 'Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US) AppleWebKit/533.1 (KHTML, like Gecko) Maxthon/3.0.8.2 Safari/533.1',
	shell : 'maxthon',
	shell_version: 0  //Maxthon 3.x in IE-Core cannot be recognised and it doesn't have exact version number
},
{
...
//TheWorld
{
	...
	shell : 'theworld',
	shell_version: 3  //TheWorld 2.x cannot be recognised, so if recognised default set verstion number to 3
},
{
...
test('ua.extra.shell/shell_version', function() {
	object.use('ua.extra, sys', function(exports, ua, sys) {
		...
		for(var i=0,l=userAgents_extra.length,current; i<l; i++) {
			current = userAgents_extra[i];
